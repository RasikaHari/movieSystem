    ...
    <div class="container">
        ...
        <div class="right-containers">
            <div class="container-box">
                ...
                <a href="/customerList" class="quick-action-btn">View Customer List</a>
            </div>
            <div class="container-box">
                <h3>Quick Reports</h3>
                <a href="/movieReport" class="quick-action-btn">Movie Report</a>
                <a href="/showTimeReport" class="quick-action-btn">Showtime Report</a>
            </div>
        </div>
    </div>
</body>
