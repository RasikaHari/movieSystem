        ...
        <div class="container mx-auto text-center">
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div class="movie-card">
                    <img src="https://via.placeholder.com/250x350" alt="Movie" class="w-full rounded-lg mb-6">
                    <h3 class="text-xl font-semibold">Cosmic Adventure</h3>
                </div>
                <div class="movie-card">
                    <img src="https://via.placeholder.com/250x350" alt="Movie" class="w-full rounded-lg mb-6">
                ...
                <div class="movie-card">
                    <img src="https://via.placeholder.com/250x350" alt="Movie" class="w-full rounded-lg mb-6">
                    <h3 class="text-xl font-semibold">Animated Wonders</h3>
                </div>
            </div>
        </div>
    </section>
